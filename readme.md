...
Простая программа для учета картриджей и других материалов. Tupical usage - вы один, матответсвенный и что то выдаете со склада. Что выдали, то , в основном пропало, но может и вернуться не использованным. Перед руководством вам нужен ежемесячный отчет об уходе, плюс поглядывать остатки и рассчитывать закупки. 
